...
/**
 * Provides vertical obstacle functionality for the Repulsor field-obstacle model used by the
...
public class VerticalObstacle extends Obstacle {
  /**
   * Configuration value for x. The valid range and tuning source are defined by the owning
   * subsystem or field profile.
   */
  public double x;

  /**
   * Returns the vertical obstacle value maintained by this Repulsor component.
   *
