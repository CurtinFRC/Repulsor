...
public class RectangleObstacle extends Obstacle {
  ...
  private Translation2d[] corners() {
    return RectangleGeometry.corners(center, halfX, halfY, rot);
  }
  ...
  private static double minSampleDistanceToPolygon(
    ...
    return RectangleGeometry.minSampleDistanceToPolygon(a, b, poly);
  }

  private static boolean segmentIntersectsPolygon(
      Translation2d a, Translation2d b, Translation2d[] poly) {
    return RectangleGeometry.segmentIntersectsPolygon(a, b, poly);
  }
  ...
  public boolean intersectsRectangle(Translation2d[] rectCorners) {
    return RectangleGeometry.intersectsRectangle(corners(), rectCorners);
  }
}
