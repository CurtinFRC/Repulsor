...
public final class PredictiveCollectCandidateBuilder {
  ...
  public static Translation2d[] buildResourceClustersMulti(SpatialDyn dyn, int maxClusters) {
    ...
    HashMap<Long, org.curtinfrc.frc2026.util.Repulsor.Predictive.Core.Internal.ClusterAcc> coarse =
        new HashMap<>(256);
    ...
    for (DynamicObject o : dyn.resources) {
      ...
      org.curtinfrc.frc2026.util.Repulsor.Predictive.Core.Internal.ClusterAcc a = coarse.get(k);
      if (a == null) {
        a = new org.curtinfrc.frc2026.util.Repulsor.Predictive.Core.Internal.ClusterAcc();
        coarse.put(k, a);
      }
    ...
    for (var e : coarse.entrySet()) {
      org.curtinfrc.frc2026.util.Repulsor.Predictive.Core.Internal.ClusterAcc a = e.getValue();
    ...
    for (int i = 0; i < m; i++) {
      ...
      org.curtinfrc.frc2026.util.Repulsor.Predictive.Core.Internal.ClusterAcc a = coarse.get(key);
      if (a == null || a.sw <= 1e-9) continue;
